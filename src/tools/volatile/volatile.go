 ...
 * @section DESCRIPTION
 *
 * Simple workaround to make sure a memory location is re-read.
 * Rely on the fact that the linker does not perform further optimization steps (inlining + optimizing out 'mov (regA), regB').
**/
