...
LINE0 = '"go-stack-treiber"'
LINE1 = '"c-stack-treiber"'
...
GO_FILE0 = '"data/data.st.thr.p40.dat"'
GO_FILE1 = '"data/data.st.thr.p50.dat"'
GO_FILE2 = '"data/data.st.thr.p60.dat"'

C_FILE0 = '"data_c/data.st.thr.p40.dat"'
C_FILE1 = '"data_c/data.st.thr.p50.dat"'
C_FILE2 = '"data_c/data.st.thr.p60.dat"'
...
plot \
     @GO_FILE0 using 1:(column_select(1)) title @LINE0 ls 1 with linespoints, \
     @C_FILE0 using 1:(column_select(0)) title @LINE1 ls 2 with linespoints
...
set ytics offset ytics_offset
plot \
     @GO_FILE1 using 1:(column_select(1)) title @LINE0 ls 1 with linespoints, \
     @C_FILE1 using 1:(column_select(0)) title @LINE1 ls 2 with linespoints
...
unset ylabel
plot \
     @GO_FILE2 using 1:(column_select(1)) title @LINE0 ls 1 with linespoints, \
     @C_FILE2 using 1:(column_select(0)) title @LINE1 ls 2 with linespoints
