...
plot \
     @C_FILE0 using 1:(column_select(1)) title @LINE0 ls 1 with linespoints, \
...
set ytics offset ytics_offset
plot \
     @C_FILE1 using 1:(column_select(1)) title @LINE0 ls 1 with linespoints, \
...
unset ylabel
plot \
     @C_FILE2 using 1:(column_select(1)) title @LINE0 ls 1 with linespoints, \
...
unset ylabel
plot \
     @C_FILE3 using 1:(column_select(1)) title @LINE0 ls 1 with linespoints, \
...
unset ylabel
plot \
     @C_FILE4 using 1:(column_select(1)) title @LINE0 ls 1 with linespoints, \
