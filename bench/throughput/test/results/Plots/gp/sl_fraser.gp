...
GO_FILE0 = '"data/data.sl.i8192.u1.dat"'
GO_FILE1 = '"data/data.sl.i4096.u10.dat"'
GO_FILE2 = '"data/data.sl.i2048.u20.dat"'
GO_FILE3 = '"data/data.sl.i512.u50.dat"'
GO_FILE4 = '"data/data.sl.i128.u100.dat"'

C_FILE0 = '"data_c/data.sl.lf.i8192.u1.dat"'
C_FILE1 = '"data_c/data.sl.lf.i4096.u10.dat"'
C_FILE2 = '"data_c/data.sl.lf.i2048.u20.dat"'
C_FILE3 = '"data_c/data.sl.lf.i512.u50.dat"'
C_FILE4 = '"data_c/data.sl.lf.i128.u100.dat"'
...
plot \
     ...
     @GO_FILE0 using 1:(column_select(0)) title @LINE1 ls 2 with linespoints
...
plot \
     ...
     @GO_FILE1 using 1:(column_select(0)) title @LINE1 ls 2 with linespoints
...
plot \
     ...
     @GO_FILE2 using 1:(column_select(0)) title @LINE1 ls 2 with linespoints
...
plot \
     ...
     @GO_FILE3 using 1:(column_select(0)) title @LINE1 ls 2 with linespoints
...
plot \
     ...
     @GO_FILE4 using 1:(column_select(0)) title @LINE1 ls 2 with linespoints
