...
set output 'pdf/ll_get_'.hostname.'.pdf'
...
PLOT0 = '"No contention\n{/*0.6(get ops, 0% updates)}"'
PLOT1 = '"Medium contention\n{/*0.6(get ops, 20% updates)}"'
PLOT2 = '"High contention\n{/*0.6(get ops, 50% updates)}"'

# ##########################################################################################
# XEON #####################################################################################
# ##########################################################################################

FILE0 = '"data/'.hostname.'.ll.u0.dat"'
FILE1 = '"data/'.hostname.'.ll.u20.dat"'
FILE2 = '"data/'.hostname.'.ll.u50.dat"'
