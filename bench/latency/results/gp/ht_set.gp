...
set output 'pdf/ht_set_'.hostname.'.pdf'
...
PLOT0 = '"Medium contention\n{/*0.6(set ops, 20% updates)}"'
PLOT1 = '"High contention\n{/*0.6(set ops, 50% updates)}"'
PLOT2 = '"Only contention\n{/*0.6(set ops, 100% updates)}"'

# ##########################################################################################
# XEON #####################################################################################
# ##########################################################################################

FILE0 = '"data/'.hostname.'.ht.u20.dat"'
FILE1 = '"data/'.hostname.'.ht.u50.dat"'
FILE2 = '"data/'.hostname.'.ht.u100.dat"'
